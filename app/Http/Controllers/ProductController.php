...
class ProductController extends Controller
{
    ...
    public function index(Request $request): View
    {
        ...
        $totalCosts = Product::select(DB::raw('SUM(cost * in_stock) as totalcost'))->value('totalcost'); // Total records
        $totalPrices = Product::select(DB::raw('SUM(retailsale_price * in_stock) as totalPrices'))->value('totalPrices'); // Total records
        // dd($totalCosts);
