...
@section('content')
    ...
    <div class="pt-3 d-flex gap-5 justify-content-end px-5">
        <div class="d-flex gap-1">
            <div style="font-weight:bold">SUM COSTS:</div>
            <div>{{ currency_format($totalCosts) }}</div>
        </div>
        <div class="d-flex gap-1">
            <div style="font-weight:bold">SUM PRICES:</div>
            <div>{{ currency_format($totalPrices) }}</div>
        </div>
    </div>
    </x-card>
@endsection
